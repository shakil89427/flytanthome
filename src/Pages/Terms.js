      ...
      <div className="max-w-[1000px] mx-auto px-5 my-32">
        ...
        >
          ...
          <li>
            ...
            our Service and collaborate with others on research to make our
            Service better and contribute to the well-being of our community.
          </li>
          <li>
          ...
          <li>
            ...
            our growing community. Organizing and analyzing information for our
            growing community is central to our Service. A big part of our
            Service is creating and using cutting-edge technologies that help us
          ...
          <li>
            ...
            discover, and share. We want to strengthen your relationships
            through shared experiences you actually care about. So we build
            systems that try to understand who and what you and others care
          ...
          <li>
            ...
            and use tools and offer resources to our community members that help
            to make their experiences positive and inclusive, including when we
            think they might need help. We also have teams and systems that work
            ...
            We also may share information about misuse or harmful content with
            other Companies or law enforcement.
          </li>
          <li>
          ...
          <li>
            You can’t attempt to buy, sell, or transfer any aspect of your
            account (including your username) or solicit, collect, or use login
            credentials or badges of other users.
          </li>
          <li>
            You can’t post private or confidential information or do anything
            that violates someone else’s rights, including intellectual
            property.
          </li>
          <li>
          ...
          <li>
            ...
            content. We do not claim ownership of your content that you post on
            or through the Service. Instead, when you share, post, or upload
            content that is covered by intellectual property rights (like photos
            or videos) on or in connection with our Service, you hereby grant to
            ...
            of your content (consistent with your privacy and application
            settings). You can end this license anytime by deleting your content
            or account. However, content will continue to appear if you shared
          ...
          <li>
            ...
            sponsored content. You give us permission to show your username,
          ...
          <li>
            ...
            license to modify, create derivative works of, decompile, or
            otherwise attempt to extract source code from us.
          </li>
          <li>
            We can remove any content or information you share on the Service if
            we believe that it violates these Terms of Use or we are permitted
            or required to do so by law. We can refuse to provide or stop
            providing all or part of the Service to you (including terminating
            or disabling your account) immediately to protect our community or
            services, or if you create risk or legal exposure for us, if you
            repeatedly infringe other people’s intellectual property rights, or
            where we are permitted or required to do so by law. If we take
            action to disable or terminate your account, we will notify you
            where appropriate. If you believe your account has been terminated
            in error, or you want to disable or permanently delete your account,
            then you can contact us.
          </li>
          <li>
            Content you delete may persist for a limited period of time in
            backup copies and will still be visible where others have shared it.
            This paragraph, and the section below called “Our Agreement and What
            Happens if We Disagree,” will still apply even after your account is
            terminated or deleted.
          </li>
          <li>
            Your use of content on the Service is also subject to our
            guidelines, and your use of our API is subject to our Platform
            Policy. If you use certain other features or related services,
            additional terms will be made available and will also become a part
            of our agreement. If any aspect of this agreement is unenforceable,
            the rest will remain in effect.
          </li>
          <li>
            Any amendment or waiver to our agreement must be in writing and
            signed by us. If we fail to enforce any aspect of this agreement, it
            will not be a waiver. And we reserve all rights not expressly
            granted to you.
          </li>
          <li>
          ...
          <li>
            ...
            they are possible. This includes when we delete your content,
          ...
          <li>
            ...
            you agree that the claim must be resolved exclusively in the Indian
            district Court for the New Delhi, that you submit to the personal
            jurisdiction of either of these courts for the purpose of litigating
            any such claim, and that the laws of theIndia will govern these
            Terms and any claim, without regard to conflict of law provisions.
          </li>
          <li>
            We may change our Terms of Use, Service and policies, and we may
            need to make changes to these. And if you continue to use the
            Service, you will be bound by the updated Terms.
          </li>
        </div>
      </div>
      <ContactBar />
