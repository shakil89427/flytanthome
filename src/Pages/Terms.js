    ...
    <div className="max-w-[1100px] mx-auto px-5 my-32">
      ...
      >
        <li>
          ...
          sponsored content that we believe will be meaningful to you. And we
          try to make that content as relevant as possible to you.
        </li>
        <li>
        ...
        <li>
          Ensuring a stable global infrastructure for our Service – To provide
          our global Service, we must store and transfer data across our systems
          around the world, including outside of your country of residence. Try
          your luck with This infrastructure may or may not be owned or operated
          by Flytant Developers Pvt. Ltd. or their affiliates.
        </li>
        <li>
          Developing and using technologies that help us consistently serve our
          growing community. Organizing and analyzing information for our
          ...
          personalize, protect, and improve our Service on an incredibly large
          scale for a broad global community. Technologies like artificial
          intelligence and machine learning give us the power to apply complex
          processes across our Service. Automated technologies also help us
          ensure the functionality and integrity of our Service.
        </li>
        <li>
          Offering personalized opportunities to create, connect, communicate,
          discover, and share. We want to strengthen your relationships through
          ...
          offers, and accounts you might be interested in, and offering ways for
          you to experience Flytant, based on things you and others do on and
          off Flytant.
        </li>
        <li>
          Fostering a positive, inclusive, and safe environment – We develop and
          use tools and offer resources to our community members that help to
          make their experiences positive and inclusive, including when we think
          they might need help. We also have teams and systems that work to
          combat abuse and violations of our Terms and policies, as well as
          harmful and deceptive behavior. We use all the information we
          have-including your information-to try to keep our platform secure. We
          also may share information about misuse or harmful content with other
          Companies or law enforcement.
        </li>
        <li>
          Your commitments – We require you to make the below commitments to us,
          in return for our commitment to provide the service. Who Can Use You
          must be at least 13 years old or the minimum legal age in your country
          to use Flytant. You must not be prohibited from receiving any aspect
          of our service under applicable laws or engaging in payments related
          services if you are on an applicable denied party listing. We must not
          have previously disabled your account for violation of law or any of
          our policies. You must not be a convicted sex offender.
        </li>
        <li>
          You can’t impersonate others or provide inaccurate information. You
          don’t have to disclose your identity on Flytant, but you must provide
          us with accurate and up to date information (including registration
          information). Also, you may not impersonate someone you aren’t, and
        ...
        <li>
          ...
          or our policies, including in particular the Flytant Community
        ...
        <li>
          ...
          in unauthorized ways. This includes creating accounts or collecting
        ...
        <li>
          ...
          to use it. Nothing is changing about your rights in your content. We
        ...
        <li>
          ...
          about your relationships and actions with accounts, ads, and sponsored
          content. You give us permission to show your username, profile
          picture, and information about your actions (such as likes) or
          relationships (such as follows) next to or in connection with
          accounts, ads, offers, and other sponsored content that you follow or
          engage with that are displayed on Flytant Products, without any
          compensation to you. For example, we may show that you liked a
          sponsored post created by a brand that has paid us to display its ads
          on Flytant. As with actions on other content and followers of other
          accounts, actions on sponsored content and followers of sponsored
        ...
        <li>
          ...
          have and make available in our Service (for example, images, designs,
          videos, or sounds we provide that you add to content you create or
          share), we retain all rights to our content (but not yours).
        </li>
        <li>
          You can only use our intellectual property and trademarks or similar
          marks only with our prior written permission.
        </li>
        <li>
        ...
        <li>
          ...
          we believe that it violates these Terms of Use or we are permitted or
          required to do so by law. We can refuse to provide or stop providing
          all or part of the Service to you (including terminating or disabling
          your account) immediately to protect our community or services, or if
          you create risk or legal exposure for us, if you repeatedly infringe
          other people’s intellectual property rights, or where we are permitted
          or required to do so by law. If we take action to disable or terminate
          your account, we will notify you where appropriate. If you believe
          your account has been terminated in error, or you want to disable or
          permanently delete your account, then you can contact us.
        </li>
        <li>
          ...
          paragraph, and the section below called “Our Agreement and What
          Happens if We Disagree,” will still apply even after your account is
          terminated or deleted.
        </li>
        <li>
          Your use of content on the Service is also subject to our guidelines,
          and your use of our API is subject to our Platform Policy. If you use
          certain other features or related services, additional terms will be
          made available and will also become a part of our agreement. If any
          aspect of this agreement is unenforceable, the rest will remain in
          effect.
        </li>
        <li>
          Any amendment or waiver to our agreement must be in writing and signed
          by us. If we fail to enforce any aspect of this agreement, it will not
          be a waiver. And we reserve all rights not expressly granted to you.
        </li>
        <li>
          This agreement does not give rights to any third parties. You cannot
          transfer your rights or obligations under this agreement without our
          consent. Our rights and obligations can be assigned to others. For
        ...
        <li>
          Our Service is provided “as is,” and we can’t guarantee it will be
          safe and secure or will work perfectly all the time. TO THE EXTENT
        ...
        <li>
          ...
          will apply to any claim, cause of action, or dispute you have against
          us that arises out of or relates to these Terms (“claim”), and you may
          ...
          claim must be resolved exclusively in the Indian district Court for
          the New Delhi, that you submit to the personal jurisdiction of either
          of these courts for the purpose of litigating any such claim, and that
          the laws of theIndia will govern these Terms and any claim, without
          regard to conflict of law provisions.
        </li>
        <li>
          We may change our Terms of Use, Service and policies, and we may need
          to make changes to these. And if you continue to use the Service, you
          will be bound by the updated Terms.
        </li>
      </div>
    </div>
  );
