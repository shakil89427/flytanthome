      ...
      <div className="max-w-[1100px] mx-auto px-5 my-32">
        ...
        >
          ...
          <li>
            ...
            (like metadata), such as the location of a photo or the date a file
            was created. It can also include what you see through features we
            provide, such as our camera, so we can do things like suggest masks
            and filters that you might like, or give you tips on using camera
            formats. Our systems automatically process content and
            communications you and others provide to analyze context and what's
            in them for the purpose of great user experience.
          </li>
          <li>
            We also receive and analyze content, communications and information
            that other people provide when they use our products. Enjoy with.
            This can include information about you, such as when others share or
          ...
          <li>
            ...
            and other content you view on our platforms. We also collect
          ...
          <li>
            ...
            transaction. This includes payment information, such as your credit
            or debit card number and other card information; other account and
          ...
          <li>
            ...
            transaction again then we suggest to use the same debit or credit
            card to ensure hassle free experience for the user.
          </li>
          <li>
            ...
            across our platforms, such as people you communicate with the most
            or groups you are part of. We also collect contact information if
            ...
            things like helping you and others find people you may know.
          </li>
          <li>
            ...
            about your use of our platform on your phone to better personalize
            the content (including ads) or features you see when you use our
            platform on another device, such as your laptop or tablet, or to
            measure whether you took an action in response to an ad we showed
          ...
          <li>
            We collect information about operations and behaviors performed on
            the device, such as whether a window is in foreground or background,
            or mouse movements (which can help distinguish humans from bots).
          </li>
          <li>
            We use unique identifiers, device IDs, and other identifiers, such
            as apps or accounts that you use.
          </li>
          <li>
            We use device signals such as bluetooth signals, and information
          ...
          <li>
            ...
            such as about your device, websites you visit, purchases you make,
            the ads you see, and how you use their services. We also receive
            information about your online and offline actions and purchases from
            third-party data providers who have the rights to provide us with
            your information.
          </li>
          <li>
          ...
          <li>
            ...
            platform. To create personalized platform that are unique and
            relevant to you, we use your connections, preferences, interests and
            activities based on the data we collect and learn from you and
            others (including any data with special protections you choose to
            provide); how you use and interact with our platform; and the
            people, places, or things you're connected to and interested in on
            and off our platform.
          </li>
          <li>
            ...
            be based on things like precise device location (if you've allowed
            us to collect it), IP addresses, and information such as check-ins
          ...
          <li>
            ...
            your interests, actions and connections-to select and personalize
            ads, offers and other sponsored content that we show you and how we
            use your choices over the data we use to select ads.
          </li>
          <li>
          ...
          <li>
            ...
            safety and security on and off our platform. For example, we use
          ...
          <li>
            ...
            we have about migration patterns during crises to aid relief
            efforts.
          </li>
        </div>
        <h4 className="text-xl md:text-2xl lg:text-3xl font-medium  text-gray-800 mt-32 mb-14">
        ...
        >
          ...
          <li>
            ...
            service – Don’t confuse, deceive, defraud, mislead, or harass
          ...
          <li>
            Provide meaningful customer support for your app, and make it easy
          ...
          <li>
            ...
            access, use, or disclosure. For example, don’t use data obtained
            from us to provide tools that are used for surveillance.
          </li>
          <li>
            Don’t transfer any data that you receive from us (including
          ...
          <li>
            ...
            money games of skill, or online lotteries, get our written
          ...
          <li>
            ...
            promote content that violates any rights of any person, including
          ...
          <li>
            ...
            and payout obligations to third parties in connection with your app
            or website.
          </li>
          <li>
          ...
          <li>
            ...
            content, and other information made available by you or on your
            behalf in connection with your use of our Platform. This license
            survives even if you stop using the platform feature. You are
            responsible for obtaining the necessary rights from all applicable
            rights holders to grant this license. Any content made available by
            you or on your behalf in connection with the platform features is
          ...
          <li>
            ...
            the provision and that the other provisions remain in full force and
            effect.
          </li>
          <li>
