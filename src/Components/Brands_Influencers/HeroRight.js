...
const HeroRight = ({ data }) => {
  return (
    <>
      <div className="bg-black text-white px-5 py-44 max-w-[1300px] flex flex-col lg:flex-row items-center mx-5 lg:mx-auto gap-28 justify-center rounded-xl relative">
