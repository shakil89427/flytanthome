...
const HeroLeft = ({ data }) => {
  return (
    <>
      <div className="bg-black text-white px-5 py-44 w-[90%] flex flex-col-reverse md:flex-row items-center mx-5 lg:mx-auto gap-28 justify-center rounded-xl relative">
